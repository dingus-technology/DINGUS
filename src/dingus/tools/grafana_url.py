...
if __name__ == "__main__":
    prometheus_uid = "ced0tisnw1v5se"
    queries = [
        {"refId": "A", "expr": 'cpu_load{job="sanitised-data"}'},
    ]
    from_time = "2025-02-15 18:00:00"
    to_time = "2025-02-15 20:00:00"

    url = generate_grafana_url(prometheus_uid, queries, from_time, to_time)
    print(url)
